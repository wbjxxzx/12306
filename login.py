...
class My12306(object):
    ...
    def doLogin(self):
        ...
        self.doPOST("https://kyfw.12306.cn/otn/login/userLogin", 
        ...
        self.doPOST("https://kyfw.12306.cn/passport/web/auth/uamtk", 
            parse.urlencode({"appid": "otn"}), headers=headers)

        self.doPOST("https://kyfw.12306.cn/otn/uamauthclient", 
            parse.urlencode({"tk": self.tokenParams["tk"]}))
